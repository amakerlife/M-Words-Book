...
//	file.open("words.txt");
	/*--------------------------------------------------------------------------*/
			system("title M Words Book 单词本 v1.2.1 - 正在初始化");
			system("cls");
			cout<<"正在初始化 已完成 20%\n";
			system("echo off");
			...
			system("cls");
			cout<<"正在初始化 已完成 40%\n";
			system("copy .\\Lab121.a C:\\Users\\%USERNAME%\\AppData\\Roaming\\MWordsBook");
			system("cls");
			cout<<"正在初始化 已完成 60%\n";
			system("del .\\Lab121.a");
			system("cls");
			cout<<"正在初始化 已完成 80%\n";
			system("ren C:\\Users\\%USERNAME%\\AppData\\Roaming\\MWordsBook\\Lab121.a Lab121.exe");
			system("cls");
			cout<<"正在初始化 已完成 100%\n";
			system("cls");
	/*--------------------------------------------------------------------------*/
	memset(jieguo,1,sizeof(jieguo));
	system("title M Words Book 单词本 v1.2.1   By Makerlife");
	cout<<"欢迎使用 M Words Book 单词本\n版本 v1.2.1"<<endl;
	cout<<"本程序由 Makerlife 开发"<<endl;
	cout<<"您可以访问下方网址进行更新"<<endl;
	cout<<"https://amakerlife.github.io/MWB"<<endl;
	cout<<"输入1进入实验室版本，输入其他以继续！"<<endl;
	int inputa;
	cin>>inputa;
	if(inputa==1)
	{
		system("start C:\\Users\\%USERNAME%\\AppData\\Roaming\\MWordsBook\\Lab121.exe");
		return 0;
	}
